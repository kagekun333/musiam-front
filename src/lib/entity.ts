...
export const ENTITY = {
  ...
  /** 一行説明 */
  description:
    "ABI伯爵（Kagemichi Abiko）が館主を務める、350の作品でできた一つの国「伯爵MUSIAM」。AI制作パイプラインで楽曲・書籍を量産し、350作品（楽曲216リリース・書籍134）を公開している音楽家・作家。歩けば発見があり、常にどこかで一曲が流れ、その中心では伯爵とAIが世界を鍛え続けている。",
} as const;
